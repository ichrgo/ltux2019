...
jQuery(document).ready(function($){
	$('.system-theme-settings').before('<div class="theme-setting-header"><div class="col-half theme-brand"><h3><span>P</span>PANA THEME</h3></div><div class="col-half theme-version">1.0</div></div>');
});
;
/**
* DO NOT EDIT THIS FILE.
